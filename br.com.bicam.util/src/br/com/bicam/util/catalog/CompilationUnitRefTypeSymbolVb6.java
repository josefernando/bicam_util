...
public class CompilationUnitRefTypeSymbolVb6 extends VisualBasic6BaseListener{
...
//	File compUnitFile;
	...
	public CompilationUnitRefTypeSymbolVb6(PropertyList _propertyList){
...
//		if(sym == null) return;
		...
		System.err.println("**** DEBUG ONLY" + prop);
		Symbol_New dataTypeSym = scope.resolve(prop);
