...
public class CatalogRefTypeSymbolVb6 extends VisualBasic6BaseListener{
//	String absoluteFileName; // nome do diretório do projeto VB6
	...
	public CatalogRefTypeSymbolVb6(PropertyList _propertyList){
		...
		this.sourceVersion   = (SourceVersion) properties.getProperty("SOURCE_VERSIO");
	}
