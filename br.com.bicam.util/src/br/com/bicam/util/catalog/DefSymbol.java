...
public class DefSymbol {
	...
	public DefSymbol(PropertyList _properties) throws IOException {
...
*/
			...
			Vb6CompilationUnitDefSymbol defCompUnit = new Vb6CompilationUnitDefSymbol(properties);

	        walker.walk(defCompUnit, astree);
	}	
...
/*		Version version = (Version) properties.getProperty("VERSION");
		...
		System.err.println("DEF SYMBOL SqlTransactSybase - " + source.getId());
		ParseTreeWalker walker = new ParseTreeWalker();
		SqlTransactSybaseCompilationUnitDefSymbol defCompUnit = new SqlTransactSybaseCompilationUnitDefSymbol(properties);
