...
public class RefTypeSymbol {
	...
	public RefTypeSymbol(PropertyList _properties) throws IOException {
/*		
...
*/
	...
	private static void vb6CompilationUnit(PropertyList _properties) {
			...
			Vb6CompilationUnitRefTypeSymbol refTypeCompUnit = new Vb6CompilationUnitRefTypeSymbol(properties);

	        walker.walk(refTypeCompUnit, astree);
	}	
...
//		String compilationUnitType = (String) properties.getProperty("COMPILATION_UNIT_TYPE");
		...
		System.err.println("DEF SYMBOL VB6 - " + source.getId());
		ParseTreeWalker walker = new ParseTreeWalker();
		SqlTransactSybaseCompilationUnitRefTypeSymbol refTypeCompUnit = new SqlTransactSybaseCompilationUnitRefTypeSymbol(properties);
