...
public class GetParameterByPosition extends VisualBasic6BaseListener{
	SymbolTable_New	st;
	...
	public GetParameterByPosition(PropertyList _properties) {
...
//===============================================================================		
		...
		ParserRuleContext stmtContext = NodeExplorer_New.getAncestorClass(functionContext, "StmtContext", true);
		String startIndexContext = null;
		String lineContext = null;
...
//=================================================================================
		...
		ParserRuleContext stmtContext = NodeExplorer_New.getAncestorClass((ParserRuleContext)functionContext, "StmtContext", true);
		String startIndexContext = null;
		String lineContext = null;
